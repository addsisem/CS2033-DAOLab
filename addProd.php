...
<body>
    ...
    <a class="navbar-brand" href="listProducts.php">
            CS 2033 Web Systems Add Product
    </a>
    </nav>
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <form action="addProd.php" method="POST">
                            <label for="categoryID" class="form-label">Category ID</label>
                                        <input type="text" class="form-control mb-3" id="categoryID" name="categoryID" placeholder="Enter the Product's Category ID" required>
